  ...
  render() {
    ...
    return (
      <div>
        ...
        <h2>迷你版本:</h2>
        <Pagination className="mini" current={this.state.index} showTotal showQuickJumper onChange={me.handleChange.bind(me)} total={50} sizeOptions={[5, 10, 20]} pageSize={5} showSizeChanger />
        <h2>简单地翻页:</h2>
